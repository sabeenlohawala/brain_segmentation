...
for activate_mapping in [True, False]:
    ...
    with open(f"../images/pixel_counts_no_exclude_{activate_mapping}.pkl", 'wb') as pickle_file:
        pickle.dump(pixel_counts_no_exclude, pickle_file)
    with open(f"../images/pixel_counts_exclude_{activate_mapping}.pkl", 'wb') as pickle_file:
        pickle.dump(pixel_counts_exclude, pickle_file)
    with open(f"../images/pixel_counts_crop_{activate_mapping}.pkl", 'wb') as pickle_file:
        pickle.dump(pixel_counts_crop, pickle_file)
    with open(f"../images/pixel_counts_small_{activate_mapping}.pkl", 'wb') as pickle_file:
        pickle.dump(pixel_counts_small, pickle_file)
    with open(f"../images/pixel_counts_padding_{activate_mapping}.pkl", 'wb') as pickle_file:
        pickle.dump(pixel_counts_padding, pickle_file)
    with open(f"../images/pixel_counts_orig_{activate_mapping}.pkl", 'wb') as pickle_file:
